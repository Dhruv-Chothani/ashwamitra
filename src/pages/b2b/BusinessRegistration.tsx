    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-3xl mx-auto mb-4">
            🏢
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Business Registration</h1>
          <p className="text-gray-600">Register your business to start sourcing fresh agricultural produce</p>
        </div>
